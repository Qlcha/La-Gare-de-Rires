...
if(isset($_POST['Envoyer'])){
    ...
    $index = mysqli_query($connexion, "SELECT id,pseudo,pass,valide FROM LOGIN WHERE pseudo='".mysqli_real_escape_string($connexion, stripcslashes(utf8_decode($_POST['pseudo'])))."' AND pass='".mysqli_real_escape_string($connexion, utf8_decode($_POST['motdepass']))."'");
    //si pas de résultat
	...
	while($result = mysqli_fetch_array($index, MYSQLI_ASSOC)){
